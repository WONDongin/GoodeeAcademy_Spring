...
//		mav.setViewName("item/list"); view이름이 null인경우 요청 URL에서 가져옴
	...
	// http://localhost:8080/shop1/item/update?id=1 요청
	// http://localhost:8080/shop1/item/delete?id=1 요청
	...
	/*
	 * Item item : 파라미터의 이름과 같은 item 클래스의 setProperty를 이용하여
	 *             파라미터 값 저장
	 *     Item item = new Item();
