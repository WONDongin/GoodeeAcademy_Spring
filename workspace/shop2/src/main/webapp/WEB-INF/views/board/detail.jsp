...
<body>
    ...
    <%-- 댓글 등록, 조회, 삭제 --%>
    <%-- http://localhost:8080/board/detail?num=39#comment 요청 --%>
   	<%-- #comment : id 속성의 값이 comment 위치로 포커스(fragment) --%>
    ...
    <form:form modelAttribute="comment" action="comment" method="post" name="commForm">
        ...
        <div class="w3-col s7 w3-center">
            <p>
                <form:input path="content" class="w3-input w3-border" placeholder="댓글내용"/>
                ...
                <tr>
                    ...
                    <td class="w3-right">
                        ...
                        <form action="commdel" method="post" name="commdel${stat.index}">
                            ...
                            <a href="javascript:document.commdel${stat.index}.submit()">삭제</a>
                        </form>
                    </td>
                </tr>
            </c:forEach>
